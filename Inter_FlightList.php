...
<form class="example" action="Inter_FlightList.php" method="POST" style=" margin:auto;max-width:400px;">
...
echo '</table>';
         ...
         $q = "SELECT Flight_ID FROM InterSeatNum
                   WHERE Flight_ID = '$id' "; 
               ...
               if($inject_query){
					 ...
					 window.location.href = 'Seat_Inter.php';
					 </script> ";
...
<table style="background: green;">
	<caption><h1>International Flight Schedule</h1></caption>
  <tr>
    <th>Flight ID</th>
    <th>Date</th>
    <th>Start Time</th>
